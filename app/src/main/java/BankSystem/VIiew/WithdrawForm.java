...
public class WithdrawForm extends javax.swing.JFrame {
    ...
    private void ConfirmBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmBtnActionPerformed
        ...
        TransactionModel transaction = new TransactionModel(UUID.randomUUID(),
                Double.parseDouble(amountextField.getText()),LocalDate.now(), "withdraw");
        try {
            TransactionController.createWithdraw(transaction, UUID.fromString(AccountIdTxtField.getText()),MainForm.identificationLabel.getText());
